...
class TrainingsplanErstellen extends StatefulWidget {
  const TrainingsplanErstellen({super.key});

  @override
  State<TrainingsplanErstellen> createState() => _TrainingsplanErstellenState();
}

class _TrainingsplanErstellenState extends State<TrainingsplanErstellen> {
  ...
  final List<TrainingsplanUebung> _selectedUebungen = [];
  ...
  void _savePlan() async {
    if (_formKey.currentState!.validate() && _selectedUebungen.isNotEmpty) {
      ...
      try {
        final newPlan = Trainingsplan(
          name: name,
          uebungen: _selectedUebungen,
          erstellungsdatum: DateTime.now(),
        );
        
        await _databaseHelper.insertTrainingsplan(newPlan);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Trainingsplan erstellen', style: AppTextStyles.heading),
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Trainingsplan speichern'),
              ),
            ],
          ),
        ),
